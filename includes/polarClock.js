function clock(){
    ...
    function getShade(index){
       if (index==0) { result ='rgba(0,0,0,1)'; } //
		else if(index==1){ result ='rgba(0,0,0,.85)'; } //
		else if(index==2){ result ='rgba(0,0,0,.7)'; }
		else if(index==3){ result ='rgba(0,0,0,.55)'; }
		else if(index==4){ result ='rgba(0,0,0,.40)'; } //
		else if(index==5){ result ='rgba(0,0,0,.25)'; } //
		return result;
    }
